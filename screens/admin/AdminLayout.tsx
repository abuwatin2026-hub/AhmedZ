...
const navLinks: Array<{ to: string; label: string; icon: React.ReactNode; permission: AdminPermission }> = [
  ...
  { to: 'driver-map', label: '🗺️ خريطة المندوبين', icon: <Icons.TruckIcon />, permission: 'orders.view' },
  { to: 'online-orders', label: '🌐 الطلبات الأونلاين', icon: <Icons.CartIcon />, permission: 'orders.updateStatus.all' },
  { to: 'driver-location', label: '📍 موقعي (مندوب)', icon: <Icons.TruckIcon />, permission: 'orders.updateStatus.delivery' },
  ...
  { to: 'eosb', label: 'نهاية الخدمة', icon: <Icons.FileText />, permission: 'expenses.manage' },
  { to: 'recruitment', label: 'التوظيف', icon: <Icons.CustomersIcon />, permission: 'hr.contracts.manage' },
  { to: 'kitting', label: 'التجميع', icon: <Icons.Package />, permission: 'stock.manage' },
  { to: 'inventory-withdrawal', label: 'طلبات صرف المخزون', icon: <Icons.ListIcon />, permission: 'stock.manage' },
  { to: 'sales-reps', label: 'مندوبو المبيعات', icon: <Icons.CustomersIcon />, permission: 'orders.view' },
  { to: 'letters-of-credit', label: 'الاعتمادات المستندية', icon: <Icons.MoneyIcon />, permission: 'accounting.manage' },
...
const routePermissions: Record<string, AdminPermission> = {
  ...
  'driver-map': 'orders.view',
  'online-orders': 'orders.updateStatus.all',
  'driver-location': 'orders.updateStatus.delivery',
  'items': 'items.manage',
  ...
  'eosb': 'expenses.manage',
  'recruitment': 'hr.contracts.manage',
  'kitting': 'stock.manage',
  'inventory-withdrawal': 'stock.manage',
  'sales-reps': 'orders.view',
  'letters-of-credit': 'accounting.manage',
