...
create or replace function public.run_base_currency_historical_restatement_v2b(
...
begin
  ...
  loop
    ...
    values (
      v_post_ts,
      concat('Historical base currency restatement v2b (SAR)', E'\n', 'Original JE: ', v_entry.id::text),
      'base_currency_restatement',
      v_entry.id::text,
      'historical_base_currency_restatement_v2b',
      auth.uid(),
      v_entry.journal_id,
      v_entry.document_id,
      v_entry.branch_id,
...
revoke all on function public.run_base_currency_historical_restatement_v2b(int, timestamptz) from public;
grant execute on function public.run_base_currency_historical_restatement_v2b(int, timestamptz) to authenticated;
