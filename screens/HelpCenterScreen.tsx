...
const HelpCenterScreen: React.FC = () => {
  ...
  const helpTopics: Record<string, HelpTopic> = useMemo(() => {
    const topics: Record<string, HelpTopic> = {
      ...
      '/admin/reports/tax': {
        title: 'التقرير الضريبي (VAT)',
        intro: 'استخراج ملخص لضريبة المبيعات والمشتريات لتيسير الإقرار الضريبي.',
        sections: [
          {
            title: 'المتطلبات',
            bullets: [
              'تأكد من إدخال الرقم الضريبي ونسبة الضريبة في الإعدادات العامة.',
              'تأكد من تسجيل فواتير المشتريات متضمنة للضريبة إن وجدت.',
            ],
          },
          {
            title: 'الاستخدام',
            bullets: [
              'حدد الفترة الضريبية (مثال: ربع سنوي أو شهري).',
              'سيحسب النظام إجمالي ضريبة المخرجات (المبيعات) وضريبة المدخلات (المشتريات).',
              'الفرق بينهما يمثل المبلغ المستحق سداده أو استرداده من هيئة الزكاة والضريبة.',
            ],
          },
        ],
      },
      '/admin/backup-settings': {
        title: 'النسخ الاحتياطي والاسترداد (Backup & Restore)',
        intro: 'ميزة متقدمة وحصرية لك: حماية بياناتك وأرشفتها واسترجاعها بضغطة زر عند الحاجة.',
        sections: [
          {
            title: 'طريقة أخذ النسخة',
            bullets: [
              'افتح إدارة النسخ الاحتياطي من الإعدادات.',
              'اختر "نسخة احتياطية كاملة (JSON)" وسيتم تضمين جميع الجداول والسجلات المحاسبية والعمليات كاملة.',
              'احفظ الملف لديك بصيغة (عبدالناصر ABD. او JSON) في مكان آمن أو على الفلاش درايف.',
              'إذا رغبت بملخص للمدراء فقط اختر "تصدير ملخص (Excel)".',
            ],
          },
          {
            title: 'طريقة الاسترداد أو النقل الجديد',
            bullets: [
              'حتى لو قمت بإنشاء قاعدة بيانات جديدة للمشروع (Supabase Production جديدة) في المستقبل.',
              'فقط ادخل لهذه الشاشة في النظام الجديد.',
              'اضغط الزر المخصص للاسترداد وارفع ملف النسخة القديم.',
              'سيقوم النظام تدريجياً وبدقة عالية بإفراغ الجداول الحالية وإعادة حقن جميع أرصدتك وفواتيرك وبياناتك من حيث توقفت.',
              'تأكد من عدم اغلاق المتصفح أثناء الاسترداد وانتظر حتى تلم إشعار "اكتمل بنجاح".',
            ],
          },
          {
            title: 'ملاحظات هامة جداً',
            bullets: [
              'الاسترداد يمسح البيانات الموجودة حالياً ليضع مكانها بيانات النسخة.',
              'احرص دائماً قبل أي إجراء استرداد أن تأخذ نسخة أخرى من وضعك الحالي الاحتياطي.',
            ],
          },
        ],
      },
      ...
      '/admin/eosb': {
        ...
        intro: 'احتساب وتتبع مكافأة نهاية الخدمة بشكل شهري تراكمي لكل موظف وفق معايير النظام.',
        sections: [
          {
            title: 'كيف يعمل النظام',
            bullets: [
              'يحتسب النظام الاستحقاق الشهري تلقائياً بناءً على الراتب الأساسي وسنوات الخدمة.',
              'أول 5 سنوات: تُحتسب بمعدل يوم/سنة قابل للتعديل (افتراضي 22 يوماً/سنة).',
              'بعد 5 سنوات: تُحتسب بمعدل أعلى (افتراضي 30 يوماً/سنة).',
              'يمكن تفعيل خيار لإضافة البدلات إلى قاعدة الاستحقاق.',
            ],
          },
          {
            title: 'احتساب شهري',
            bullets: [
              'اختر الفترة الشهرية (YYYY-MM) ثم اضغط "احتساب هذا الشهر".',
              'يُجري الحساب لجميع الموظفين النشطين وينشئ سجلات في قاعدة البيانات.',
              'يمكن إعادة الاحتساب دون تكرار البيانات (لا يُكرر سجل لنفس الفترة والموظف).',
              'يعرض الرصيد التراكمي الإجمالي لكل موظف منذ بداية التوظيف.',
            ],
          },
          {
            title: 'إعدادات الاحتساب',
            bullets: [
              'تبويب "إعدادات الاحتساب": تعديل عدد أيام السنة لكل مرحلة.',
              'الحد الأدنى للاستحقاق: الموظف لا يستحق إلا بعد اكتمال المدة المحددة (افتراضي سنة).',
              'تفعيل "شمول البدلات" يجعل مجموع الراتب + البدلات هو الأساس.',
            ],
          },
        ],
      },
      ...
      '/admin/recruitment': {
        title: 'طلبات التوظيف',
        intro: 'إدارة طلبات الاستقطاب واستعراض المتقدمين وتتبع مراحل التوظيف من التقديم حتى التعيين.',
        sections: [
          {
            title: 'إنشاء طلب توظيف',
            bullets: [
              'اضغط "طلب توظيف جديد" وأدخل المسمى الوظيفي والإدارة والعدد المطلوب.',
              'حدد أولوية الطلب: منخفضة/عادية/عالية/عاجلة.',
              'أضف وصف الوظيفة ومتطلباتها.',
              'بعد الإنشاء يبقى الطلب مفتوحاً لإضافة المتقدمين.',
            ],
          },
          {
            title: 'إدارة المتقدمين',
            bullets: [
              'اختر طلب توظيف من القائمة الرئيسية لعرض المتقدمين.',
              'اضغط "إضافة متقدم" لتسجيل بيانات متقدم جديد (الاسم/الهاتف/المصدر).',
              'تتبع حالة كل متقدم: تقدّم → مراجعة → مقابلة → اجتمع → عرض مرسل → تم التعيين.',
              'عند تعيين متقدم يتحدث عداد "المعيّن" في بطاقة الطلب تلقائياً.',
            ],
          },
          {
            title: 'حالات الطلبات',
            bullets: [
              'مفتوح: يقبل طلبات التقديم.',
              'جاري: عملية التوظيف نشطة.',
              'موقوف: تعليق مؤقت.',
              'مغلق: اكتمل التوظيف أو انتهى الطلب.',
            ],
          },
        ],
      },
      ...
      '/admin/kitting': {
        title: 'الأصناف المركبة (Kitting)',
        intro: 'تعريف قوائم المكونات (BOM) وتنفيذ عمليات التجميع والتفكيك وتتبع حركات المستودع.',
        sections: [
          {
            title: 'تعريف قائمة المكونات (BOM)',
            bullets: [
              'اختر الصنف المركب من قائمة الأصناف.',
              'في تبويب "قائمة المكونات": اختر المكوّن وأدخل الكمية المطلوبة ثم اضغط "إضافة".',
              'يُحدَّد الصنف تلقائياً كـ "مركب" عند إضافة أول مكوّن له.',
              'يمكن تعريف أي صنف كصنف رئيسي ومكوّن في نفس الوقت.',
            ],
          },
          {
            title: 'تنفيذ التجميع (Assemble)',
            bullets: [
              'اختر نوع العملية "تجميع"، ثم المستودع والكمية المطلوب تجميعها.',
              'يقوم النظام باستهلاك المكونات وزيادة مخزون الصنف المركب.',
              'إذا كان المخزون غير كافٍ للمكونات ستظهر رسالة خطأ.',
            ],
          },
          {
            title: 'تنفيذ التفكيك (Disassemble)',
            bullets: [
              'اختر "تفكيك" لإرجاع الصنف المركب إلى مكوناته.',
              'يُخصم من مخزون الصنف المركب ويُضاف للمكونات.',
              'مفيد عند الإرجاع أو إعادة تصنيف المخزون.',
            ],
          },
          {
            title: 'سجل العمليات',
            bullets: [
              'تبويب "سجل العمليات" يعرض جميع عمليات التجميع والتفكيك بالتاريخ والمستودع.',
              'يوفر مرجعاً كاملاً لمراجعة حركات تجميع المخزون.',
            ],
          },
        ],
      },

      '/admin/inventory-withdrawal': {
        title: 'طلبات صرف المخزون',
        intro: 'سير عمل كامل لطلب ومتابعة وصرف المخزون بنظام الاعتماد المسبق.',
        sections: [
          {
            title: 'إنشاء طلب صرف',
            bullets: [
              'اضغط "طلب جديد" واختر المستودع والإدارة والغرض.',
              'أضف الأصناف المطلوبة مع الكمية لكل صنف.',
              'يمكن إضافة عدة أصناف في طلب واحد.',
              'الطلب ينشأ بحالة "مسودة" ولا يؤثر على المخزون بعد.',
            ],
          },
          {
            title: 'سير الاعتماد',
            bullets: [
              'مسودة → (تقديم للاعتماد) → في انتظار الاعتماد.',
              'يمكن لصاحب الصلاحية اعتماد أو رفض الطلب.',
              'عند الاعتماد يمكن ضبط كميات مختلفة عن المطلوبة.',
              'الرفض يتطلب إدخال سبب ويُوقف الطلب.',
            ],
          },
          {
            title: 'تنفيذ الصرف',
            bullets: [
              'بعد الاعتماد يظهر زر "تنفيذ الصرف".',
              'عند التنفيذ تُسجَّل حركات صرف فعلية في المخزون.',
              'تتحدث حالة الطلب إلى "منفذ" وتُسجَّل أرقام حركات المخزون.',
            ],
          },
        ],
      },
      ...
      '/admin/sales-reps': {
        ...
        intro: 'إدارة فريق المبيعات ومتابعة عمولاتهم الشهرية وتحقيقهم للأهداف.',
        sections: [
          {
            title: 'إضافة مندوب',
            bullets: [
              'اضغط "مندوب جديد" وأدخل البيانات الأساسية: الاسم، الهاتف، المنطقة الجغرافية.',
              'حدد نوع العمولة: نسبة مئوية من قيمة الطلب، أو مبلغ ثابت لكل طلب.',
              'حدد الهدف الشهري لمتابعة نسبة الإنجاز.',
            ],
          },
          {
            title: 'احتساب العمولات',
            bullets: [
              'اضغط "احتساب عمولات الشهر" مع اختيار الفترة المطلوبة.',
              'يحتسب النظام عمولة كل مندوب بناءً على الطلبات المنجزة (حالة: تم التسليم).',
              'النتائج تُسجَّل في سجل العمولات ويمكن مراجعتها لكل مندوب.',
            ],
          },
          {
            title: 'لوحة الأداء',
            bullets: [
              'اختر مندوباً من القائمة لرؤية: عدد الطلبات، الإيراد الكلي، نسبة الهدف، إجمالي العمولة.',
              'الجدول السفلي يعرض عمولات كل طلب بالفترة والمبلغ والحالة.',
            ],
          },
          {
            title: 'ربط الطلبات بالمندوب',
            bullets: [
              'من شاشة إدارة الطلبات يمكن تعيين مندوب مبيعات لكل طلب.',
              'العمولة تُحسب فقط على الطلبات التي حالتها "تم التسليم".',
            ],
          },
        ],
      },
      ...
      '/admin/letters-of-credit': {
        title: 'الاعتمادات المستندية (LC)',
        intro: 'إدارة اعتمادات الاستيراد: فتح الاعتماد، تسجيل السحبات والمصاريف، ومتابعة الرصيد المتبقي.',
        sections: [
          {
            title: 'فتح اعتماد جديد',
            bullets: [
              'اضغط "اعتماد جديد" وأدخل: رقم الاعتماد، المورد، البنك، العملة، القيمة، تاريخ الفتح والانتهاء.',
              'حدد نوع الاعتماد: لدى الاطلاع (Sight)، آجلة (Usance)، متجددة (Revolving)، ضمان (Standby).',
              'يمكن إدخال شروط التسليم Incoterms وبنود الدفع.',
            ],
          },
          {
            title: 'تسجيل السحبات',
            bullets: [
              'في تبويب "سحبات": سجّل كل شحنة بتاريخها ومبلغها ورقم بوليصة الشحن (BL).',
              'يتحدث رصيد الاعتماد المستخدم تلقائياً بعد كل سحبة.',
              'شريط التقدم يُظهر نسبة الاستخدام وصولاً إلى 100%.',
              'تتغير الحالة تلقائياً: مفتوح → مسحوب جزئياً → مسحوب بالكامل.',
            ],
          },
          {
            title: 'تسجيل المصاريف',
            bullets: [
              'في تبويب "مصاريف": سجّل مصاريف الاعتماد (عمولة فتح، رسوم بنكية، تأمين، شحن، جمارك).',
              'يمكن ربط كل مصروف بقيد محاسبي.',
              'ملخص إجمالي المصاريف يظهر في بطاقة الاعتماد.',
            ],
          },
          {
            title: 'متابعة الرصيد',
            bullets: [
              'بطاقة الاعتماد تعرض: القيمة الكلية، المستخدم، المتبقي.',
              'تاريخ الانتهاء واضح في كل بطاقة لتنبيه المستخدم مسبقاً.',
            ],
          },
        ],
      },
