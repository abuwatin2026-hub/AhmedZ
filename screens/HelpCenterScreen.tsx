...
const HelpCenterScreen: React.FC = () => {
  ...
  const helpTopics: Record<string, HelpTopic> = useMemo(() => {
    return {
        ...
        sections: [
          ...
          },
          {
            ...
            bullets: [
              ...
              'في الدفع عبر الكريمي: يجب رفع صورة إشعار أو إدخال رقم العملية.',
              'إن كانت "شبكة" متاحة: اخترها واتبّع تعليمات المندوب عند التسليم.',
            ],
          },
          {
          ...
          },
          {
            ...
            bullets: [
              ...
              'طريقة الدفع: نقد/كريمي/شبكة حسب الإعدادات المتاحة.',
        ...
        sections: [
          ...
          },
          {
            ...
            bullets: [
              ...
              'المدفوعات غير النقدية (شبكة/تحويل) لا تُحتسب ضمن النقد المتوقع لأنها لا تدخل الصندوق نقداً.',
      ...
      '/admin/prices': {
        title: 'إدارة الأسعار',
        intro: 'تعديل الأسعار ومراجعة التغييرات عند توفر سجل الأسعار.',
        sections: [
          {
            title: 'الاستخدام',
            bullets: [
              'حدّث سعر الصنف ثم احفظ.',
              'قد تُعرض لك معلومات سجل السعر لتتبع التغييرات.',
              'بعد تغيير السعر راجع السلة/الإتمام للتأكد أن الحسابات صحيحة.',
            ],
          },
        ],
      },
      '/admin/price-tiers': {
        ...
        sections: [
          ...
          },
          {
            ...
            bullets: [
              'يختار النظام السعر الأنسب تلقائياً بناءً على نوع العميل والكمية.',
              'تُطبّق الأسعار الخاصة أولاً ثم شرائح الكمية حسب القواعد.',
            ],
          },
          {
            title: 'الحقول والأزرار',
      ...
      '/admin/import-shipments': {
        title: 'الشحنات',
        intro: 'تتبع الشحنات الواردة وربطها بأوامر الشراء والمستودعات.',
        sections: [
          {
            title: 'الاستخدام',
            bullets: [
              'سجل بيانات الشحنة وتواريخ الوصول.',
              'اربط الأصناف الواردة للاستلام المنظم.',
            ],
          },
        ],
      },
      '/admin/import-shipments/:id': {
        title: 'تفاصيل الشحنة',
        intro: 'عرض تفاصيل شحنة محددة وربطها بالاستلام والمستودعات.',
        sections: [
          {
            title: 'المحتويات',
            bullets: [
              'تفاصيل الأصناف والكميات المتوقعة والواصلة.',
              'تواريخ الوصول والملاحظات.',
            ],
          },
          {
            title: 'الربط والاستلام',
            bullets: [
              'ربط كل صنف بأمر الشراء والاستلام الفعلي.',
              'تحديث المخزون ومتوسط التكلفة بعد الاستلام.',
            ],
          },
        ],
      },
        ...
        sections: [
          ...
          },
          {
            ...
            bullets: [
              ...
              'تفعيل طرق الدفع المتاحة (عند الاستلام/الكريمي/شبكة).',
