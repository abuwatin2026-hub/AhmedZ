...
begin
  ...
  v_base_price := public.get_item_price_with_discount(p_item_id, null::uuid, v_qty);
...
revoke execute on function public.rpc_reload_postgrest_schema() from anon;
grant execute on function public.rpc_reload_postgrest_schema() to authenticated;
