-- Fix create_order_secure to allow Staff to create In-Store orders and assign customers
...
-- Update create_order_secure_with_payment_proof to match params and validation
