-- Migration: Fix Sales Report to rely on Inventory Movements (INV-001)
-- Date: 2026-01-31
-- Description: Update get_product_sales_report_v9 to consider an order as a "Sale" ONLY if it has a corresponding 'sale_out' inventory movement.
    ...
    where eo.date_by >= p_start_date
      ...
      and exists (
        ...
        where im.reference_table = 'orders'
          and im.reference_id = eo.id::text
