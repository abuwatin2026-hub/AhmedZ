drop function if exists public.get_fefo_pricing(uuid, uuid, numeric);
drop function if exists public.get_fefo_pricing(uuid, uuid, numeric, uuid);
...
revoke all on function public.get_fefo_pricing(text, uuid, numeric, uuid) from public;
revoke execute on function public.get_fefo_pricing(text, uuid, numeric, uuid) from anon;
grant execute on function public.get_fefo_pricing(text, uuid, numeric, uuid) to authenticated;
