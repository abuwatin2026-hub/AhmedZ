create or replace function public._compute_promotion_snapshot(
  p_promotion_id uuid,
  p_customer_id uuid,
  p_warehouse_id uuid,
...
revoke all on function public._compute_promotion_snapshot(uuid, uuid, uuid, numeric, text, boolean) from public;
grant execute on function public._compute_promotion_snapshot(uuid, uuid, uuid, numeric, text, boolean) to authenticated;
...
begin
  ...
  return public._compute_promotion_snapshot(
    p_promotion_id,
    v_customer_id,
    v_warehouse_id,
    v_bundle_qty,
