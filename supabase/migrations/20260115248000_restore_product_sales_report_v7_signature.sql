drop function if exists public.get_product_sales_report_v7(text, text, text);
drop function if exists public.get_product_sales_report_v7_core(timestamptz, timestamptz, text);
